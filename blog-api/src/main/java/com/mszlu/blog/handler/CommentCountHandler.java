...
@Slf4j
@EnableScheduling
public class CommentCountHandler {
    @Autowired
    ...
    public void scheduled(){
        log.info("=====>>>>> commentCount同步浏览量开始执行  {}",new DateTime().toString("yyyy-MM-dd HH:mm:ss"));
        Map<Object, Object> countMap = redisTemplate.opsForHash().entries("comment_count");
        ...
        log.info("=====>>>>> commentCount同步浏览量结束  {}",new DateTime().toString("yyyy-MM-dd HH:mm:ss"));
    }
}
